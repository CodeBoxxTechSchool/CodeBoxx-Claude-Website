export default {
  ...
  process: {
    ...
    title: 'Three steps to a confirmed seat',
    steps: [
  ...
  ask: {
    ...
    formTitle: 'Request the tuition sheet',
    fullNameLabel: 'Full Name',
    fullNamePlaceholder: 'First Last',
    emailLabel: 'Email',
    emailPlaceholder: 'name@company.com',
    programLabel: 'Program of Interest',
    programPlaceholder: 'AI Native Full-Stack Developer',
    answeredNote: 'Answered within one business day.',
    send: 'Send',
  },
};
