export default {
  ...
  codi: {
    name: 'Codi',
    role: 'CodeBoxx AI Agent',
    active: 'Active',
    greeting: 'Codi here, the CodeBoxx agent. Ask about the studio, the platform or the academy.',
  ...
  testimonials: { clientEyebrow: 'Client Testimonials', gradEyebrow: 'Graduate Testimonials' },
  clientQuotes: [
    {
      quote:
  ...
  about: {
    team: {
      ...
      people: {
        'nicolas-genest': { role: 'CEO & Co-Founder' },
        'remi-gagnon': { role: 'CDO' },
        'felix-antoine-paradis': { role: 'CTO' },
        'martin-chantal': { role: 'General Manager' },
        'marie-france-nolin': { role: 'Administrative Assistant' },
        'brian-peret': { role: 'Academy Director' },
        'francis-patry-jessop': { role: 'Director of Coaching' },
        'cederic-noel': { role: 'Director of Delivery' },
        'dovev-weaver-sr': { role: 'Director of Communities & Outcomes' },
      },
    },
    history: {
      title: 'History',
  ...
  forge: {
    superhead: 'Lead. Think. Write. Run.',
    heading: 'CodeBoxx w/ CrewKit Forge 20',
    body: 'Plan, build and run your software in one shell, two deployment paths. One executive chassis, five integrated touch surfaces, low-cost local computing by default and cloud escalation when warranted. Up to 20 heavy software workstreams in parallel: a complete end-to-end software development team in one appliance.',
    features: [
  ...
  academyTopics: {
    ...
    courses: {
      ...
      titleLine2: 'Programs that fit your journey.',
      blurbPara1:
    ...
    team: {
      titleLine1: 'Meet Your Team',
      blurb: 'Placement is the exit criterion, not a job board.',
      detail:
      ...
      teamLabel: 'Academy Team',
      people: {
        'etienne-gonthier-lapointe': { role: 'Coach' },
        'raina-dejute': { role: 'Student Success Coordinator' },
        'brian-peret-academy': { role: 'Academy Director' },
        'francis-patry-jessop-academy': { role: 'Director of Coaching' },
      },
    },
  },
  cohort: [
  ...
  contact: {
    ...
    mobileQ: 'Is it a mobile phone?',
    yes: 'Yes',
    no: 'No',
    languageQ: 'Select your preferred language.',
    english: 'English',
    french: 'French',
    consentTextPart1:
      'By submitting this form, you agree that we may call, text, and email you additional information on CodeBoxx programs. You understand that you can unsubscribe at any time including by emailing your request to ',
    ...
    sentNote: 'Brief received. Reply within 1 business day.',
    notSentNote: 'No sales sequence. One reply from a human.',
    submit: 'Submit',
  },
  enroll: {
    kicker: 'Enroll',
    ...
    yes: 'Yes',
    no: 'No',
    languageQ: 'Preferred Language',
    english: 'English',
    french: 'French',
    contactMethodQ: 'Preferred Communication Method',
    phone: 'Phone',
    sms: 'SMS',
    email: 'Email',
    streetPlaceholder: '1200 Central Ave',
    cityPlaceholder: 'St. Petersburg',
    regionPlaceholder: 'Florida',
