export default {
  ...
  band: {
    ...
    lede: "CodeBoxx Ventures met la capacité de livraison du studio derrière des produits en lesquels nous croyons. Argent, capital, ou les deux — la structure suit l'étape où vous êtes.",
    pitchButton: 'Présentez votre projet',
  },
  models: {
    ...
    items: [
      [
        ...
        'Nous prenons une part du coût de construction en capital et livrons le produit avec vous.',
        [
          'Pod de livraison assigné au démarrage',
          'Répartition argent/capital convenue avant le cadrage',
          'Les fondateurs gardent le contrôle de la feuille de route',
        ],
      ],
      [
        'Ventures cofondées',
      ...
      [
        ...
        'Des diplômés de l’Académie intégrés dans les entreprises du portefeuille.',
        [
  ...
  pitchDrawer: {
    ...
    kindLabel: 'Quel type de projet',
    selectPlaceholder: 'Sélectionner',
    projectKinds: ['Application native', 'Application Web', 'Projet basé sur le Web', 'Autre'],
    describeLabel: 'Décrivez votre projet en quelques mots',
    reviewedNote: "Révisé dans un délai d'un jour ouvrable.",
    receivedNote: 'Présentation reçue.',
    submit: 'Envoyer',
  },
};
