export default {
  ...
  about: {
    team: {
      ...
      people: {
        ...
        'felix-antoine-paradis': { role: 'CTO' },
        'martin-chantal': { role: 'Directeur général' },
        'marie-france-nolin': { role: 'Adjointe administrative' },
        'brian-peret': { role: "Directeur de l'Académie" },
        'francis-patry-jessop': { role: 'Directeur du coaching' },
        'cederic-noel': { role: 'Directeur de la livraison' },
        'dovev-weaver-sr': { role: 'Directeur des communautés et des résultats' },
      },
    },
    history: {
      title: 'Historique',
  ...
  solutions: {
    role: 'Innover, créer, adapter',
    name: 'L’ère du vibe coding',
    introPara1:
  ...
  services: {
    ...
    agentic: {
      ...
      sub: 'Faire passer votre service au niveau supérieur',
      steps: [
        [
          'Auditer votre écosystème',
          'Nous cartographions les outils, canaux et conversations déjà en place : où arrivent les demandes, comment elles sont traitées aujourd’hui, et ce qu’une résolution vous coûte réellement en temps.',
        ],
        [
          'Faire un état de la situation',
          'Vous recevez une lecture claire de ce que nous avons trouvé. Volumes, temps de réponse, les demandes qui valent la peine d’être automatisées et celles qui doivent rester avec un humain.',
        ],
        [
          'Bâtir un plan et le suivre',
          'Un déploiement cadré avec des dates et des mesures. L’agent est formé sur votre marché, évalué avant sa mise en service, puis ajusté selon les chiffres convenus.',
        ],
      ],
      close:
        "Trois qualités non négociables pour livrer une expérience client digne de ce nom. Nous comprenons qu'un tel changement peut être stressant. C'est pourquoi nous vous accompagnons tout au long du processus.",
    },
    custom: {
  ...
  academyTopics: {
    ...
    courses: {
      ...
      titleLine2: 'Des programmes adaptés à votre parcours.',
      blurbPara1:
        "Nous connaissons bien les horaires chargés. C'est pourquoi nous avons conçu nos programmes pour s'adapter à divers besoins et niveaux d'engagement.",
      blurbPara2:
    ...
    team: {
      titleLine1: 'Rencontrez votre équipe',
      blurb: "Le placement est le critère de réussite, pas un babillard d'emplois.",
      detail:
        "Vos instructeurs chez CodeBoxx sont des professionnels expérimentés et passionnés, animés par l'envie d'enseigner et de vous aider à réussir. Au-delà d'un manuel, ils apportent en classe une expérience et une expertise concrètes, vous offrant des conseils et un mentorat pertinents par rapport à ce que les employeurs recherchent chez leurs candidats en développement logiciel et en IA.",
      teamLabel: "Équipe de l'Académie",
      people: {
        'etienne-gonthier-lapointe': { role: 'Coach' },
        'raina-dejute': { role: 'Coordonnatrice de la réussite étudiante' },
        'brian-peret-academy': { role: "Directeur de l'Académie" },
        'francis-patry-jessop-academy': { role: 'Directeur du coaching' },
      },
    },
  },
  cohort: [
  ...
  enroll: {
    ...
    english: 'Anglais',
    french: 'Français',
    contactMethodQ: 'Méthode de communication préférée',
    phone: 'Téléphone',
    sms: 'SMS',
    email: 'Courriel',
    streetPlaceholder: '1200 Central Ave',
    cityPlaceholder: 'St. Petersburg',
    regionPlaceholder: 'Floride',
    postalPlaceholder: '33705',
    countryLabel: 'Pays',
